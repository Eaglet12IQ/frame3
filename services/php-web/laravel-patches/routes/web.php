...
Route::middleware([\App\Http\Middleware\LoggingMiddleware::class, \App\Http\Middleware\RateLimitingMiddleware::class, \App\Http\Middleware\VerifyCsrfToken::class])->group(function () {

...
Доработать на фронтенд (Laravel-решение):
1. Убрать все лишние модули, мешающие работе;
2. Добавить анимацию;
3. Разделили логику на контексты - каждой бизнес-функции должна быть отдельная
страница;
4. Добавить CSS-визуализацию;
5. Добавить гибкие дашборды с фильтрацией данных: по возрастанию, по
убыванию - с учетом даты и выбором столбца в таблице;
